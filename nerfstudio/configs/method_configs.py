...
from nerfstudio.models.splatfacto_2 import SplatfactoFinetuneModelConfig, SplatfactoFinetuneModel
...
descriptions = {
    ...
    "splatfacto_2": "Splatfacto model with finetuning capabilities.",
}
...
method_configs["splatfacto_2"] = TrainerConfig(
    method_name="splatfacto_2",
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SplatfactoFinetuneModelConfig(
            camera_optimizer=CameraOptimizerConfig(mode="off"),
        ),
    ),
    optimizers={
